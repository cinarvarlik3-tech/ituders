 ...
 * Displays a round green WhatsApp button in the bottom right corner
 * Opens WhatsApp chat with pre-filled message when clicked
 */

'use client'

export default function WhatsAppButton() {
  const phoneNumber = '905551839644'
  const message = encodeURIComponent('İTÜDers hakkında daha fazla bilgi alabilir miyim?')
